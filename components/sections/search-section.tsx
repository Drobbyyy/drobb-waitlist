  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-32 py-20 relative bg-[#F6F1EA] dark:bg-zinc-900">
      ...
      <motion.div
        ...
        className="absolute top-1/2 right-32 -translate-y-1/2 hidden lg:block"
      >
        {/* Main center image */}
        ...
        <div className="absolute -top-16 -right-16 w-[160px] h-[220px] group">
          <Image
        ...
        <div className="absolute -top-10 -left-32 w-[160px] h-[220px] group">
          <Image
        ...
        <div className="absolute -bottom-16 -right-8 w-[160px] h-[220px] group">
          <Image
